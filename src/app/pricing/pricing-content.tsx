...
// Interactive body of /pricing. The route's metadata and JSON-LD live in the
// server component (page.tsx) — a Client Component cannot export `metadata`,
// and when this file WAS the route, /pricing silently inherited the root
// layout's metadata: the homepage title, the generic site description, and a
// canonical pointing at "/". That last one told Google /pricing was a
// duplicate of the homepage, on the one page built to rank for pricing terms.
